...
#define COLOR_OFFWHITE                      (uint16_t)(0xF7BE) // màu trắng đục
#define COLOR_DARKYELLOW                    (uint16_t)(0xFC00) // màu vàng đậm
...
#define COLOR_THEME_SKYBLUE_BASE            (uint16_t)(0x957F)    // 150 180 255
